...
"""
@author: sunxianpeng
@file: SvcLinearSvcNuSvc.py
@time: 2019/10/8 16:31
"""
import numpy as np # 快速操作结构数组的工具
from sklearn import svm  # svm支持向量机
import matplotlib.pyplot as plt # 可视化绘图

# data_set = np.loadtxt(r"unsupervised_learning/SuppotVectorMachines/data/SvcLinearSvcNuSvc.txt")
data_set = np.loadtxt(r"F:\PythonProjects\python_study\sklearn_test\unsupervised_learning\SuppotVectorMachines\data\SvcLinearSvcNuSvc.txt")
