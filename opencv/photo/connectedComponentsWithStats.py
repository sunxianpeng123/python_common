...
def get_rois(image, stats):
    ...
    for stat in stats:
        ...
        x, y, w, h, area = stat
        # print('x = {},y = {},w = {},h = {},area = {}'.format(x, y, w, h, area))
...
if __name__ == '__main__':
    ...
    # centroids 是每个域的质心坐标
    img_path = r'F:\PythonProjects\python_common\opencv\photo\image\5.jpg'
    ...
    print(stats)
    stats = stats[stats[:, 0].argsort()]  # 按照第3列对行排序
